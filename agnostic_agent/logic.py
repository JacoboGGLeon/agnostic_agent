...
def build_graph_agent(
    ...
    summarizer_tool = CallablePipelineTool(
        ...
        handler=lambda payload: execute_summarizer_node(
            ...
            build_response_bundle=payload.context["build_response_bundle"],
            render_response_bundle=payload.context["render_response_bundle"],
    ...
    def summarizer_node(state: State) -> Dict[str, Any]:
        ...
        out = invoke_pipeline_tool_or_raise(
            ...
            context={
                ...
                "build_response_bundle": build_response_bundle,
                "render_response_bundle": render_response_bundle,
