...
tools: ["query_transactions_db", "query_accounting_db", "get_saneamiento_rate", "reconcile_credit_accounting"]
knowledge: ["*"]
---
...
3. `get_saneamiento_rate` para obtener la tasa esperada segun `estatus`.
